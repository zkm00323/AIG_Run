...
foreach(_expectedTarget c10_cuda c10 torch_cpu torch_cpu_library torch_cuda torch_cuda_library torch_cuda_cu torch_cuda_cu_library torch_cuda_cpp torch_cuda_cpp_library torch torch_library)
...
set_target_properties(torch_cuda PROPERTIES
  INTERFACE_LINK_LIBRARIES "torch_cuda_cpp_library;torch_cuda_cu_library"
)
...
# Create imported target torch_cuda_cu
add_library(torch_cuda_cu SHARED IMPORTED)

set_target_properties(torch_cuda_cu PROPERTIES
  INTERFACE_COMPILE_OPTIONS "\$<\$<OR:\$<CONFIG:Debug>,\$<CONFIG:RelWithDebInfo>>:/Z7>;/EHsc;/DNOMINMAX;/wd4267;/wd4251;/wd4522;/wd4522;/wd4838;/wd4305;/wd4244;/wd4190;/wd4101;/wd4996;/wd4275;/bigobj"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "-INCLUDE:?searchsorted_cuda@native@at@@YA?AVTensor@2@AEBV32@0_N1@Z;torch::cudart;c10_cuda;torch::nvtoolsext;torch_cpu_library;caffe2::cufft;caffe2::curand;caffe2::cublas;caffe2::cudnn-public"
)

# Create imported target torch_cuda_cu_library
add_library(torch_cuda_cu_library INTERFACE IMPORTED)

set_target_properties(torch_cuda_cu_library PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<TARGET_PROPERTY:torch_cuda_cu,INTERFACE_COMPILE_DEFINITIONS>"
  INTERFACE_COMPILE_OPTIONS "\$<TARGET_PROPERTY:torch_cuda_cu,INTERFACE_COMPILE_OPTIONS>"
  INTERFACE_INCLUDE_DIRECTORIES "\$<TARGET_PROPERTY:torch_cuda_cu,INTERFACE_INCLUDE_DIRECTORIES>"
  INTERFACE_LINK_LIBRARIES "torch_cuda_cu;\$<TARGET_PROPERTY:torch_cuda_cu,INTERFACE_LINK_LIBRARIES>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "\$<TARGET_PROPERTY:torch_cuda_cu,INTERFACE_SYSTEM_INCLUDE_DIRECTORIES>"
)

# Create imported target torch_cuda_cpp
add_library(torch_cuda_cpp SHARED IMPORTED)
...
# Create imported target torch_cuda_cpp_library
add_library(torch_cuda_cpp_library INTERFACE IMPORTED)

set_target_properties(torch_cuda_cpp_library PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<TARGET_PROPERTY:torch_cuda_cpp,INTERFACE_COMPILE_DEFINITIONS>"
  INTERFACE_COMPILE_OPTIONS "\$<TARGET_PROPERTY:torch_cuda_cpp,INTERFACE_COMPILE_OPTIONS>"
  INTERFACE_INCLUDE_DIRECTORIES "\$<TARGET_PROPERTY:torch_cuda_cpp,INTERFACE_INCLUDE_DIRECTORIES>"
  INTERFACE_LINK_LIBRARIES "torch_cuda_cpp;\$<TARGET_PROPERTY:torch_cuda_cpp,INTERFACE_LINK_LIBRARIES>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "\$<TARGET_PROPERTY:torch_cuda_cpp,INTERFACE_SYSTEM_INCLUDE_DIRECTORIES>"
)
